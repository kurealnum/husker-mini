/**
 * Fits and backtests the basketball win-probability model against real,
 * completed NBA games. Same methodology as
 ...
 *
 * Run with: npx tsx scripts/backtest-basketball-model.ts
 */
...
async function main() {
  console.error("Fetching NBA team ids...");
